 ...
 * @author User
 */
public class Win_PrintLnRemoval_NEW extends javax.swing.JFrame {

    /**
     * Creates new form PrintLnRemovalWindow
     */
    public Win_PrintLnRemoval_NEW() {
        initComponents();
...
//        jTextArea1.setText(text);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                { new Boolean(true), "Line 1: $Systems.println(\"test 1\")"},
                { new Boolean(true), "Line 23: $Systems.println(\"test 2\")"},
                { new Boolean(true), "Line 156: $Systems.println(\"test 3\")"}
            },
            new String [] {
                "Num", "Content"
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Win_PrintLnRemoval_NEW().setVisible(true);
